...
public:
	...
	*   This function is virtual so an specific atomic overrides it with it's own implementation */
	virtual void exit(double t); // Matias: adding finalization time
	virtual void exit(); // for backward compatibility
	...
	/*! Returns the full hierarchy name for this atomic. Ej: coupleModelName0.coupleModelName1.atomicModelName */
