//CPP:ATLAS-TDAQ/ScalarIpSrc2IndexVector.cpp
//CPP:ATLAS-TDAQ/ProtocolHeader2IndexVector.cpp
#if !defined ScalarIpSrc2IndexVector_h
#define ScalarIpSrc2IndexVector_h
...
class ScalarIpSrc2IndexVector: public ProtocolHeader2IndexVector {
	// State variables
	double sigma;
	int index;
...
public:
	ScalarIpSrc2IndexVector(const char *n): ProtocolHeader2IndexVector(n) {};
