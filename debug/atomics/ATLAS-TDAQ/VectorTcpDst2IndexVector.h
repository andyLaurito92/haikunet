//CPP:ATLAS-TDAQ/VectorTcpDst2IndexVector.cpp
//CPP:ATLAS-TDAQ/ProtocolHeader2IndexVector.cpp
#if !defined VectorTcpDst2IndexVector_h
#define VectorTcpDst2IndexVector_h
...
class VectorTcpDst2IndexVector: public ProtocolHeader2IndexVector {
	// State variables
	double sigma;
	int index;
...
public:
	VectorTcpDst2IndexVector(const char *n): ProtocolHeader2IndexVector(n) {};
